                        ...
                        <div className="row">
                            <div className="col-lg-6">
                                ...
                                <table className="table table-dark">
                                    <div>
                                        {this.state.records.map(rekord => <tbody><tr/><td className="w-52 h-8 text-center"><th>Testsúly</th>{rekord.bodyWeight}</td><td className="w-52 h-8 text-center"><th>Edzés időtartalma</th>{rekord.workoutTime}</td><td className="w-52 h-8 text-center"><th>Edzés időpontja</th> <tr/>{rekord.date}</td></tbody>)}
                                    </div>
                                </table>
                            </div>
                            <div className="col-lg-6">
